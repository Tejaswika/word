var x = document.getElementById("limit"),
  input = document.querySelectorAll('#realpara')[0],


  characterCount = document.querySelector('#characterCount'),
  wordCount = document.querySelector('#wordCount'),
  left = document.querySelector('#wordleft'),
...
input.addEventListener('keyup', function () {
  ...
  if (num == null || num == "") {
    left.innerHTML = "Enter limit";
    document.getElementById("wordleft").style.color = "green";

  } else {
     left.innerHTML = num - words.length;
     document.getElementById("wordleft").style.color = "black";
     document.getElementById("wordleft").style.fontSize = "23px";
    if ((num - words.length) < 0) {
      left.innerHTML = ("The limit has been exceeded by: ") + (words.length - num) + (" words");
      document.getElementById("wordleft").style.color = "red";
      document.getElementById("wordleft").style.fontSize = "15px";
